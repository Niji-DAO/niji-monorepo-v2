...
export function handleDelegateChanged(event: DelegateChanged): void {
  const tokenHolder = getOrCreateAccount(event.params.delegator.toHexString(), true, true);
