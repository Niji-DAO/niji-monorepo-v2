...
export class NounsToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class NounsToken__seedsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
  ...
  getBackDecoration(): BigInt {
    return this.value1;
  }

  getBackgroundDecoration(): BigInt {
    return this.value2;
  }
...
export class NounsToken extends ethereum.SmartContract {
  ...
  checkpoints(param0: Address, param1: BigInt): NounsToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new NounsToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<NounsToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new NounsToken__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  seeds(param0: BigInt): NounsToken__seedsResult {
    let result = super.call(
      "seeds",
      "seeds(uint256):(uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    );

    return new NounsToken__seedsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_seeds(param0: BigInt): ethereum.CallResult<NounsToken__seedsResult> {
    let result = super.tryCall(
      "seeds",
      "seeds(uint256):(uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48,uint48)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
